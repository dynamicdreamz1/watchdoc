                ...
                <>
                    ...
                    <form id='main_form'>
                        <div className='input-block'>
                            ...
                            <input type="text" name="firstName" placeholder={t('EditProfilePage.form.f13')} value={first_name} id="exampleInputFirstName"  />
                        </div>
                        {/* <div className='input-block'>
                    ...
                    <input type="text"  name="preferredFirstName" placeholder={t('EditProfilePage.form.f18')} value={props?.values?.preferredFirstName} id="exampleInputPreferredFirstName" onChange={props?.handleChange} />
                        ...
                        <div className='input-block'>
                            ...
                            <input type="text" name="lastName" placeholder={t('EditProfilePage.form.f14')} value={last_name} id="exampleInputLastName" />
                        </div>
                        <div className='input-block'>
                        ...
                        <div className='input-block'>
                            ...
                            <div className='radio-buttons'>
                                <div className='radio-button'>
                                    <input checked={sex === "male"} type="radio" id="male" name="sex" value="male" />
                                    <label htmlFor="male">{t('EditProfilePage.form.f10')}</label>
                                </div>
                                <div className='radio-button'>
                                    <input checked={sex === "female"} type="radio" id="female" name="sex" value="female"  />
                                    <label htmlFor="female">{t('EditProfilePage.form.f11')}</label>
                                </div>
                                <div className='radio-button'>
                                    <input checked={sex === "other"} type="radio" id="other" name="sex" value="other" />
                    ...
                    <input type="text"  name="weight"  placeholder={t('EditProfilePage.form.f15')} value={props?.values?.weight} id="exampleInputWeight" onChange={props?.handleChange} />
                        ...
                        <div className='input-block'>
                            ...
                            <input type="text" name="height" placeholder={t('EditProfilePage.form.f16')} value={height} id="exampleInputHeight" />
                        </div>
                        <div className='input-block'>
                        ...
                        <div className='input-block country-code'>
                            ...
                            <div className='inputs-wrapper'>
                                <input type="text" name="number" value={data?.user_data?.contact_number} ></input>
                            </div>
                        </div>
                    </form>
                </>
